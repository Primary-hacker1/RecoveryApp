        ...
        LiveEventBus
                ...
                .observe(this, new Observer<LiveMessage>() {
                    ...
                    public void onChanged(@Nullable LiveMessage msg) {
                        try {
                            if (msg.getIsConnt()) {
                                Log.d("BT_CONNECTED", "----  BT_CONNECTED    ----    " + LocalConfig.isControl);
                                Log.d("BT_CONNECTED1", LocalConfig.isControl + " 1");
                                Log.d("hexStr2Bytes", LocalConfig.isControl + " 1" );
...
//                                btDataPro.sendBTMessage(btDataPro.GetCmdCode(LocalConfig.ecgmac, "A4C13844160C", LocalConfig.oxygenmac));
                            } else {
