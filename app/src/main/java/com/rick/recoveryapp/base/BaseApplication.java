                ...
                case MESSAGE_STATE_CHANGE:
                    switch (msg.arg1) {
                        case BluetoothChatService.STATE_CONNECTED:
                            Log.d("BT_CONNECTED", "----  before       ----    " + LocalConfig.isControl);
                            LocalConfig.isControl = true;
                            Log.d("BT_CONNECTED", "----  after        ----    " + LocalConfig.isControl);
...
//                    Log.d("BT_CONNECTED", "------data    1----- " + data.toString());
                    ...
                    for (int i = 0; i < split.length; i++) {
                        ...
                        if (endStr.equals("A8")) {
                            ...
                            if (FirstList.size() >= 18){
//                                Log.d("setBlood", "------FirstList    1----- " + FirstList.toString());
                            }
                        } else {
                            FirstList.add(endStr);
                            if (FirstList.size() >= 18){
//                                Log.d("setBlood", "------FirstList    2----- " + FirstList.toString());
                                break;
                            }
                        }
                    }
                    boolean flag = FirstList.size() > 4;
//                    Log.d("BT_CONNECTED", "------data    flag ----- " + flag);
                    if (FirstList.size() > 4) {
                        //解析“数据长度”
                        int Datalength = Integer.valueOf(btDataPro.covert16to10(FirstList.get(3)));
//                        Log.d("BT_CONNECTED", "---  FirstList.size() ---" + FirstList.size());
//                        Log.d("BT_CONNECTED", "---  Datalength ---" + Datalength);
...
//                                    Log.d("BT_CONNECTED", "------return     ----- ");
//                                    return;
                                }

                            }
//                            Log.d("setBlood", "------SecondList    ----- " + SecondList.toString());
                            //  Log.d("FirstList", FirstList.get(2));
                            Log.d("BT_CONNECTED", "------Process  1     ----- " + SecondList.get(17));
                            btDataPro.Processing(SecondList, "82");//其他一般数据
                            btDataPro.Processing(FirstList, "83");//心电数据
//                            btDataPro.Processing(FirstList, "84");//
//                            btDataPro.Processing(FirstList, "85");//
...
//                    }
//                    Log.d("hexStr2Bytes", "---  FirstList ---" + FirstList.size());
                    break;
